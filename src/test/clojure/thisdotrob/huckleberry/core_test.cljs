...
#_(deftest test-resolve-single-with-variable-interpolation
  (async done
    (go
...
#_(deftest test-resolve-all-single
  (async done
    (go
...
#_(deftest test-resolve-all-single-with-exclusion
  (async done
    (go
...
#_(deftest test-resolve-all-single2
  (async done
    (go
...
#_(deftest test-resolve-coordinates
  (async done
    (go
...
#_(deftest retrieve-dep-list-with-local
  (async done
    (go
      (let [dp (<! (huckleberry/retrieve-dependencies
                     [nil nil [
...
#_(deftest test-resolve-coordinates-download
  (async done
    (go
...
#_(deftest test-resolve-coordinates-no-download
  (async done
    (go
      (let [ r (<! (huckleberry/resolve-dependencies :coordinates '[[commons-logging "1.1"]]
                                                     :retrieve false
